defmodule PhoenixPracticeWeb.VehicleController do
  use PhoenixPracticeWeb, :controller

  alias PhoenixPractice.Vehicles
  alias PhoenixPractice.Vehicles.Vehicle

  action_fallback PhoenixPracticeWeb.FallbackController
